...
use Neko\Chatbot\Interfaces\QuestionActionInterface;
use Neko\Chatbot\Interfaces\WebAccess;
use Neko\Chatbot\Messages\Outgoing\Actions\Button;
...
class Question implements JsonSerializable, WebAccess
{
    ...
    /**
     * @param \Neko\Chatbot\Messages\Outgoing\Actions\Button $button
     * @return $this
     */
