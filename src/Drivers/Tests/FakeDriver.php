...
namespace Neko\Chatbot\Drivers\Tests;

use Neko\Chatbot\Drivers\Events\GenericEvent;
use Neko\Chatbot\Interfaces\DriverInterface;
use Neko\Chatbot\Interfaces\VerifiesService;
...
class FakeDriver implements DriverInterface, VerifiesService
{
    ...
    /** @var \Neko\Chatbot\Messages\Incoming\IncomingMessage[] */
    public $messages = [];
