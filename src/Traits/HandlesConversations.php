...
use Neko\Chatbot\Messages\Conversations\Conversation;
...
{
    /**
     * @param \Neko\Chatbot\Messages\Conversations\Conversation $instance
    ...
    {
        /** @var \Neko\Chatbot\Messages\Conversations\Conversation $conversation */
        $conversation = $convo['conversation'];
